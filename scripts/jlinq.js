...
(function() {
    ...
    framework.library.extend([
     ...
     //is the date value great than the provided value
      { name:"greaterDate", type:framework.command.query, 
        method:function(value) {
            return this.compare({
                array:function() { return this.value.length > value; },
                string:function() { return new Date(this.value.substring(0,4), this.value.substring(5,7) , this.value.substring(8,10)) > new Date(value.substring(0,4), value.substring(5,7) , value.substring(8,10)); },
                other:function() {  return new Date(this.value.substring(0,4), this.value.substring(5,7) , this.value.substring(8,10)) > new Date(value.substring(0,4), value.substring(5,7) , value.substring(8,10)); }
               
            });
        }},
    { name:"greaterOrEqualDate", type:framework.command.query, 
        method:function(value) {
            return this.compare({
                array:function() { return this.value.length >= value; },
                string:function() { return new Date(this.value.substring(0,4), this.value.substring(5,7) , this.value.substring(8,10)) >= new Date(value.substring(0,4), value.substring(5,7) , value.substring(8,10)); },
    ...
    { name:"lessDate", type:framework.command.query, 
      ...
      { name:"lessOrEqualDate", type:framework.command.query, 
        method:function(value) {
            return this.compare({
                array:function() { return this.value.length <= value; },
                string:function() { return new Date(this.value.substring(0,4), this.value.substring(5,7) , this.value.substring(8,10)) <= new Date(value.substring(0,4), value.substring(5,7) , value.substring(8,10)); },
        ...
        //returns the avg of the values of the field
        ...
        // return percentaje of Records
        {name: "percentage", type: framework.command.select,
           method:function(field){
            var sum;
            jlinq.util.each(this.records, function(record){
                var value = jlinq.util.findValue(record, value);
                sum = sum == null ? value: (sum + value);
            });
            return ((sum * 100 ) /this.records.length) + '%';
           }},                
