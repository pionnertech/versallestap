        ...
        if(preg_match_all("/_\[" . $keyfile . "\]_/", $files) == 1){
          ...
          $extension = pathinfo($files, PATHINFO_EXTENSION);   
              ...
              while($uteams = mysqli_fetch_row($uteam)){
                ...
                if(copy("/var/www/html/" . $fac . "/_tmp/" . $files ,  "/var/www/html/" . $fac . "/" . $uteams[0] . "/" . basename(str_replace("_[" . $keyfile . "]_" , "", $files), "." . strtolower($extension)) . "_" . $uteams[2] . "_" . $uteams[0] . "." . $extension)){
