...
$str_query = "SELECT A.STSK_DESCRIP, A.STSK_ID, B.ISS_DESCRIP, B.ISS_ID , CONCAT(C.CTZ_NAMES, ' ' , C.CTZ_SURNAME1, ' ' , C.CTZ_SURNAME2 ) AS NAME, C.CTZ_TEL, C.CTZ_ADDRESS, A.STSK_FINISH_DATE " .
"FROM `SUBTASKS` A " .
...
echo "data:" . $manu['STSK_FINISH_DATE'] . "\n\n";
