 ...
 $.ajax({ type: "POST", 
          ...
          success : function(data){
            ...
            bootbox.alert("progreso ingresado", function(){
                ...
                $("#income-ing .task").eq(ii_ind).find(".person-sw-int").replaceWith('<i class="fa fa-group spac"></i>');
