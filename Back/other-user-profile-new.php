            ...
            <?
                                        ...
                                        if($handler = opendir("../" . $_SESSION['TxtFacility'] . "/" . $boss['BOSS'] . "_alt/" )){
                                          ...
                                          $file_extension = "";
                                           ...
                                           while (false !== ($archivos2 = readdir($handler))){
echo "<script>console.info('" . preg_match_all("/_\[" . $fila_int[0] . "\]_/", $archivos2) . " ---- " . $fila_int[1] . " ---  " . "../" . $_SESSION['TxtFacility'] . "/" . $boss['BOSS'] . "_alt/')</script>";
                                         if(preg_match_all("/_\[" . $fila_int[0] . "\]_/", $archivos2) == 1){
...
$.ajax({
          ...
          success : function (data){
              ...
              var files =  $("#D-drop").data("dfil").replace(fnam + '|', '');
