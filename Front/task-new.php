...
"INNER JOIN CITIZENS C ON(C.CTZ_RUT = A.ISS_CTZ AND CTZ_FAC_ENTER = " . $_SESSION['TxtFacility'] . ") " .
"INNER JOIN CAT D ON(D.CAT_ID = A.ISS_TYPE AND )  WHERE A.ISS_FAC_CODE = " . $_SESSION['TxtFacility'];
