...
"INNER JOIN CAT D ON(D.CAT_ID = A.ISS_TYPE)  WHERE A.ISS_FAC_CODE = " . $_SESSION['TxtFacility'] . " ORDER BY ISS_STATE, ISS_TICKET;";
                             ...
                             <?
                              ...
                              <div class="info-content" style="display:none">
                                 <div class="docs-example">
                                        ...
                                        <? if($fila1[10] !== 0) { ?>
                                        <img style="float: right" src="https://maps.googleapis.com/maps/api/staticmap?zoom=14&size=150x150&sensor=false&maptype=roadmap&markers=color:red|<? echo $fila1[10]?>">
                                        <? } else { ?>
